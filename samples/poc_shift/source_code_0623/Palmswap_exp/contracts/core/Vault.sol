...
contract Vault is ReentrancyGuardUpgradeable, IVault {
    ...
    function withdrawFees(address _receiver)
        external
        override
        returns (uint256)
    {
    ...
    function estimateUSDPOut(uint256 _amount)
        external
        view
        override
        returns (uint256)
    ...
    function sellUSDP(address _receiver)
        external
        override
        nonReentrant
        returns (uint256)
    ...
    function usdToCollateralTokenMax(uint256 _usdAmount)
        public
        view
        returns (uint256)
    {
    ...
    function usdToCollateralTokenMin(uint256 _usdAmount)
        public
        view
        returns (uint256)
    {
    ...
    function updateCumulativeFundingRate(address _indexToken, bool _isLong)
        public
    {
    ...
    function getUtilisation(address _token, bool _isLong)
        public
        view
        returns (uint256)
    {
